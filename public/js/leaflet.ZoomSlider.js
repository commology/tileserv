	...
	L.Control.Zoomslider = (function () {
		...
		var Zoomslider = L.Control.extend({
			...
			_createUI: function () {
				...
				ui.wrap_i  = L.DomUtil.create('div', ns + '-wrap leaflet-bar-part', ui.bar);
				ui.body_i  = L.DomUtil.create('div', ns + '-body', ui.wrap_i);
				ui.info    = L.DomUtil.create('div', ns + '-info', ui.body_i);
