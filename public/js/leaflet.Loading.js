...
(function () {
    ...
    function defineLeafletLoading(L) {
        L.Control.Loading = L.Control.extend({
            ...
            // add loading support to overlays; no need for corresponding overlay remove event
            _handleOverlayAdd: function (e) {
                this._handleBaseLayerChange({ layer: e.layer });
            },
            ...
            _addMapListeners: function(map) {
                ...
                map.on({
                    ...
                    overlayadd: this._handleOverlayAdd,
